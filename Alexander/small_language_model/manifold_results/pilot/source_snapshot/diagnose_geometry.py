...
def draw(report, projected, grid, support, sigma, size, straight, route, output):
    ...
    figure = plt.figure(figsize=(14, 5), layout="constrained")
    ...
    heat.set(title="Smallest full-space Jacobian singular value", xlabel="Valence", ylabel="Arousal")
    ...
    figure.savefig(output / "decoder_geometry.png", dpi=160)
    plt.close(figure)
